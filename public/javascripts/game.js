...
window.onload = () => {
  ...
  if (localStorage.getItem("id") === 1) {
    instruction = "Please Move The bat by pressing 'a' and 'd'";
  } else {
    instruction = "Please Move The bat by pressing 'Left' and 'Right' arrow";
  }
  ...
  constructor() {
    this.keyconstraints = {
      a: {
        ...
        do: () => {
          this.bat2.setPosition(this.bat2.position.x - 3, this.bat2.position.y);
        },
      },
      d: {
        pressed: false,
        do: () => {
          this.bat2.setPosition(this.bat2.position.x + 4, this.bat2.position.y);
        },
      },
      ArrowLeft: {
        pressed: false,
        do: () => {
          this.bat.setPosition(this.bat.position.x - 3, this.bat.position.y);
        },
      },
      ...
      ArrowRight: {
        pressed: false,
        do: () => {
          this.bat.setPosition(this.bat.position.x + 4, this.bat.position.y);
        },
      },
    };
